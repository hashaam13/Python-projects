...
def isValidWord(word, hand, wordList):
    ...
    if word in wordList:
        for w in word:
            if w in hand.keys() and hand[w]>=h[w]:
                t=True
            else:
                t=False
                break
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if word==".":
            print("Good bye! Total score:", score ,"points")
            break
        else:
            if isValidWord(word, hand, wordList)==True:
                ...
                print(word,"earned", s, "points.", "Total:", score ,"points")
    ...
    while True:
        ...
        if x=="n" or x=="r" or x=="e":
            if x=="n":
                ...
                playHand(hand, dictionary, HAND_SIZE)
            if x=="r":
                if hand==0:
